                    ...
                    <CardContent className="grid p-0 md:grid-cols-2 bg-white">
                        ...
                        <div className="flex flex-col items-center justify-center p-12 text-center space-y-6">
                            ...
                            <div className="flex flex-col w-full gap-3 mt-4">
                                <Button className="w-full bg-linear-to-br from-blue-950 to-blue-900 hover:-translate-y-0.5 hover:brightness-130 transition-all duration-300 text-white shadow-md gap-2 h-12 text-md cursor-pointer">
                                    <Printer size={20} />
                                    Imprimir Recibo
                                </Button>
