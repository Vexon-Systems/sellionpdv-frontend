...
export function ProdutoVendaModal({ produto, isOpen, onClose, modoEdicao}: Props){
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="overflow-hidden bg-surface-raised p-0 sm:max-w-2xl">
                <DialogHeader className="border-b bg-surface-sunken px-6 py-4">
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`
                                                        ...
                                                        transition-[border-color,background-color,box-shadow] duration-150 focus-visible:ring-3 focus-visible:ring-ring/40
                                                        ${isSelected
                ...
                <div className="px-6">
                    <div className="flex items-center justify-between rounded-lg border bg-surface-sunken px-4 py-3">
